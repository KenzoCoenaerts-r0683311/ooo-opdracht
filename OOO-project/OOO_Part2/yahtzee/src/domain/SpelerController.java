...
public class SpelerController {
	...
	public int getDice(int i) {
		return spelersLijst.getSpeler(currentSpeler - 1).getDobbelsteen(i);
	}

	public void rolDices() {
		spelersLijst.getSpeler(currentSpeler - 1).rolDobbelstenen();
	}

	public SpelersLijst getSpelersLijst() {
